...
开发地址：http://localhost:1801（与 react-ts `1800` / vue3-js `1802` / vue3-ts `1803` 错开，便于同时联调）
...
- `APP_CLIENT_ID`：`xn-admin-vue2-js`（`src/config/client.js`）；npm `name` 为 `xn-admin-vue3-options-js`
- 开发端口：`1801`（vue3-js 为 `1802`）
