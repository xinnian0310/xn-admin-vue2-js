      ...
      <el-tab-pane label="数据展示" name="data">
        ...
        <el-card shadow="never" class="demo-section">
          ...
          <el-descriptions :column="2" border size="small">
            <el-descriptions-item label="系统">xn-admin-vue2-js</el-descriptions-item>
        ...
        <el-card shadow="never" class="demo-section">
          ...
          <el-space>
            ...
            <el-popconfirm title="确认删除？" @confirm="onPopconfirm">
              <template #reference>
      ...
      <el-tab-pane label="其他" name="other">
        <el-card shadow="never" class="demo-section">
          ...
          <el-row :gutter="16">
            ...
            <el-col :span="8">
              <el-space wrap>
                <el-check-tag :checked="checkTag" @change="onCheckTagChange">可选标签</el-check-tag>
...
export default {
  ...
  data() {
    return {
      ...
      transferData: Array.from({ length: 8 }).map((_, i) => ({
        key: i,
        label: `选项 ${i + 1}`,
      })),
      tableData: [
